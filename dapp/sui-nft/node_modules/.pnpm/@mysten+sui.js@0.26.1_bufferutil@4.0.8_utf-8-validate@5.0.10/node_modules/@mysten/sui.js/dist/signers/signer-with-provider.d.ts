...
export declare abstract class SignerWithProvider implements Signer {
     ...
     * in the Sui System State object
     */
    devInspectTransaction(tx: UnserializedSignableTransaction | string | Base64DataBuffer, gasPrice?: number | null, epoch?: number | null): Promise<DevInspectResults>;
    /**
